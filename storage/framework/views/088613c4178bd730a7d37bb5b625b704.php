...
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Data Barang'))]); ?>
    <div class="space-y-8">
        <div class="flex flex-col gap-2">
            ...
            <p class="text-sm text-neutral-600 dark:text-neutral-300">
                <?php echo e(__('Catat dan kelola master barang emas yang digunakan pada simulasi cicilan.')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/gd/resources/views/barang/data-barang.blade.php ENDPATH**/ ?>