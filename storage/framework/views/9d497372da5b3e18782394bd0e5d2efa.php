                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $jadwalLelang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="align-top">
                            ...
                            <td class="mt-1 text-xs text-neutral-800 dark:text-neutral-100">
                                <div class="inline-flex items-center gap-2 rounded-full px-2 py-1 text-center text-xs font-semibold <?php echo e($resultType === 'surplus' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/60 dark:text-emerald-200' : 'bg-rose-100 text-rose-700 dark:bg-rose-900/60 dark:text-rose-200'); ?>">
                                    <?php echo e($resultType === 'surplus' ? __('(Kelebihan Uang) SURPLUS') : __('DEFISIT (Kekurangan Bayar)')); ?>
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/gadai/penyelesaian-hasil-lelang.blade.php ENDPATH**/ ?>