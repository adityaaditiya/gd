...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.settings.layout','data' => ['heading' => __('Tampilan'),'subheading' =>  __('Update tampilan aplikasi yang kamu inginkan')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['heading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Tampilan')),'subheading' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute( __('Update tampilan aplikasi yang kamu inginkan'))]); ?>
...
<?php endif; ?>
</section><?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views\livewire/settings/appearance.blade.php ENDPATH**/ ?>