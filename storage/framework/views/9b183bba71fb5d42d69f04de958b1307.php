            ...
            <form method="GET" class="grid gap-3 rounded-lg border border-neutral-200 bg-neutral-50 p-4 text-sm dark:border-neutral-700 dark:bg-neutral-900 md:grid-cols-5">
                <div class="md:col-span-2">
                    <label class="flex flex-col gap-1">
                        <span class="text-xs font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400"><?php echo e(__('Cari Nomor Cicilan / Kode Member / NIK')); ?></span>
                        <input
                            type="search"
                            name="search"
                            value="<?php echo e($filters['search'] ?? ''); ?>"
                            placeholder="<?php echo e(__('Masukan nomor cicilan, kode member atau NIK')); ?>"
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/cicil-emas/angsuran-rutin.blade.php ENDPATH**/ ?>