                ...
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="rounded-xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                        <div class="border-b border-neutral-200 px-4 py-3 dark:border-neutral-700">
                            ...
                            <p class="text-sm text-neutral-500">username: <?php echo e($user->username); ?> &middot; <span class="text-sm text-neutral-500">Role: <?php echo e($user->role); ?></span></p>
                        </div>
...
<?php endif; ?>
<?php /**PATH /var/www/gd/resources/views/admin/users/index.blade.php ENDPATH**/ ?>