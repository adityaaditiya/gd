                ...
                <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                    ...
                    <dl class="mt-4 space-y-3 text-sm text-neutral-700 dark:text-neutral-200">
                        ...
                        <div class="flex items-start justify-between gap-4">
                            ...
                            <dd class="text-right text-neutral-900 dark:text-white"><?php echo e($tarifBungaHarianDisplay); ?></dd>
                        </div>
                        <?php if($tarifBungaPerPeriodePersen !== null): ?>
                            <div class="flex items-start justify-between gap-4">
                                <dt class="font-medium text-neutral-600 dark:text-neutral-300"><?php echo e(__('Tarif Bunga per Periode')); ?></dt>
                                <dd class="text-right text-neutral-900 dark:text-white"><?php echo e(number_format($tarifBungaPerPeriodePersen, 2, ',', '.')); ?>%</dd>
                            </div>
                        <?php endif; ?>
                        <div class="flex items-start justify-between gap-4">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="rounded-xl border border-emerald-200 bg-emerald-50/70 p-6 text-sm text-emerald-800 shadow-sm dark:border-emerald-500/60 dark:bg-emerald-500/10 dark:text-emerald-200">
                    ...
                    <p class="mt-4 text-xs text-emerald-700 dark:text-emerald-200/80">
                        ...
                        ?>
                        <?php echo e(__('Nilai di atas dihitung dengan tarif bunga harian :rate% selama :billable hari tagih (:actual hari berjalan).', [
