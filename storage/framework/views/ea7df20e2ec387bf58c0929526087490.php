    ...
    <div class="space-y-6">
        <div class="flex flex-col gap-2">
            ...
            <!-- <p class="text-sm text-neutral-600 dark:text-neutral-300">
                <?php echo e(__('Pantau seluruh perpanjangan kontrak gadai termasuk tenor baru dan biaya kas yang diterima.')); ?>

            </p> -->
            <p class="text-sm text-neutral-600 dark:text-neutral-300">
                <?php echo e(__('Pantau seluruh perpanjangan kontrak gadai dan biaya yang diterima.')); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/gd/resources/views/laporan/perpanjangan-gadai.blade.php ENDPATH**/ ?>