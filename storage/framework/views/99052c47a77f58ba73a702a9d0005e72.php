            ...
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                ...
                <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                        ...
                        <tr class="align-top">
                            ...
                            <td class="px-4 py-3 text-sm text-neutral-800 dark:text-neutral-100">
                                ...
                                <div class="mt-2 text-xs text-neutral-500 dark:text-neutral-400">
                                    <?php echo e(__('Tanggal Gadai')); ?>:
                                    <span class="font-medium text-neutral-700 dark:text-neutral-200"><?php echo e(optional($transaksi?->tanggal_gadai)->translatedFormat('d F Y') ?? __('Tidak tersedia')); ?></span>
                                </div>
                                <div class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                                    <?php echo e(__('Jatuh Tempo')); ?>:
                                    <span class="font-medium text-neutral-700 dark:text-neutral-200"><?php echo e(optional($transaksi?->jatuh_tempo_awal)->translatedFormat('d F Y') ?? __('Tidak tersedia')); ?></span>
                                </div>
                                <div class="mt-2 text-xs text-neutral-500 dark:text-neutral-400">
                                ...
                                <div class="mt-1 text-xs text-neutral-500 dark:text-neutral-400">
                                    <?php echo e(__('Status Gadai')); ?>: <span class="font-medium text-indigo-600 dark:text-indigo-300"><?php echo e(__($transaksi?->status_transaksi ?? 'Aktif')); ?></span>
                                </div>
                            </td>
                            <td class="px-4 py-3 text-sm text-neutral-800 dark:text-neutral-100">
                                <div class="flex flex-col gap-1">
                            ...
                            <td class="px-4 py-3 text-sm text-neutral-800 dark:text-neutral-100">
                                <div><?php echo e(__('Limit Harga')); ?>:</div>
                                <span class="font-semibold"><?php echo e($jadwal->harga_limit !== null ? 'Rp. ' . number_format((float) $jadwal->harga_limit, 0, ',', '.') : __('-')); ?></span>
                                <div><?php echo e(__('Estimasi Biaya')); ?>:</div>
                                <span class="font-semibold"><?php echo e($jadwal->estimasi_biaya !== null ? 'Rp. ' . number_format((float) $jadwal->estimasi_biaya, 0, ',', '.') : __('-')); ?></span>
                            ...
                            <td class="px-4 py-3 text-sm text-neutral-800 dark:text-neutral-100">
                                <?php if($jadwal->hasil_status === 'laku'): ?>
                                    <div><?php echo e(__('Hasil Lelang')); ?>:</div>
                                    <span class="font-semibold">Rp. <?php echo e(number_format((float) $jadwal->harga_laku, 0, ',', '.')); ?></span>
                                    <div><?php echo e(__('Biaya Lelang')); ?>:</div>
                                    <span class="font-semibold">Rp. <?php echo e(number_format((float) $jadwal->biaya_lelang, 0, ',', '.')); ?></span>
                                    ...
                                    <div><?php echo e(__('Ke Nasabah')); ?>:</div>
                                    <span class="font-semibold">Rp. <?php echo e(number_format((float) $jadwal->distribusi_nasabah, 0, ',', '.')); ?></span>
                                    <div><?php echo e(__('Piutang Sisa')); ?>:</div>
                                    <span class="font-semibold">Rp. <?php echo e(number_format((float) $jadwal->piutang_sisa, 0, ',', '.')); ?></span>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-sm text-neutral-500 dark:text-neutral-400"><?php echo e(__('Belum ada data lelang yang dapat ditampilkan.')); ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
