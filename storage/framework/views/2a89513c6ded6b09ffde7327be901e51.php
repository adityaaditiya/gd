...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('Ubah Data Barang')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Ubah Data Barang'))]); ?>
    <div class="space-y-8">
        <div class="flex flex-col gap-2">
            ...
            <div class="space-y-1">
                <h1 class="text-2xl font-semibold text-neutral-900 dark:text-white"><?php echo e(__('Ubah Data Barang')); ?></h1>
                <p class="text-sm text-neutral-600 dark:text-neutral-300">
                    <?php echo e(__('Perbarui informasi barang emas kemudian simpan perubahan ke database.')); ?>
        ...
        <div class="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <form method="POST" action="<?php echo e(route('barang.data-barang.update', $barang)); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        id="kode_barcode"
                        name="kode_barcode"
                        value="<?php echo e(old('kode_barcode', $barang->kode_barcode)); ?>"
                        required
                        maxlength="191"
                        autofocus
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        id="kode_intern"
                        name="kode_intern"
                        value="<?php echo e(old('kode_intern', $barang->kode_intern)); ?>"
                        required
                        maxlength="191"
                        class="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 shadow-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-100 dark:border-neutral-600 dark:bg-neutral-950 dark:text-white dark:focus:border-emerald-400 dark:focus:ring-emerald-900/40"
                    />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        id="kode_baki"
                        name="kode_baki"
                        value="<?php echo e(old('kode_baki', $barang->kode_baki)); ?>"
                        required
                        maxlength="191"
                        class="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 shadow-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-100 dark:border-neutral-600 dark:bg-neutral-950 dark:text-white dark:focus:border-emerald-400 dark:focus:ring-emerald-900/40"
                    />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        id="kode_jenis"
                        name="kode_jenis"
                        value="<?php echo e(old('kode_jenis', $barang->kode_jenis)); ?>"
                        required
                        maxlength="191"
                        class="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 shadow-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-100 dark:border-neutral-600 dark:bg-neutral-950 dark:text-white dark:focus:border-emerald-400 dark:focus:ring-emerald-900/40"
                    />
                    ...
                    >
                        ...
                        <?php $__currentLoopData = $masterKodeGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $masterKodeGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option
                                ...
                                <?php if($selectedKodeGroup === $masterKodeGroup->kode_group): echo 'selected'; endif; ?>
                            >
                                <?php echo e($masterKodeGroup->kode_group); ?> — Rp <?php echo e(number_format((float) $masterKodeGroup->harga, 2, ',', '.')); ?>

                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($selectedKodeGroup && ! $hasSelectedInMaster): ?>
                            <option value="<?php echo e($selectedKodeGroup); ?>" data-price="<?php echo e($selectedPrice); ?>" selected>
                                <?php echo e($selectedKodeGroup); ?> — <?php echo e(__('(tidak ditemukan di master)')); ?>

                            </option>
                        <?php endif; ?>
                    </select>
                    <?php $__errorArgs = ['kode_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        id="kadar"
                        name="kadar"
                        value="<?php echo e(old('kadar', $barang->kadar)); ?>"
                        step="0.01"
                        min="0"
                        class="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 shadow-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-100 dark:border-neutral-600 dark:bg-neutral-950 dark:text-white dark:focus:border-emerald-400 dark:focus:ring-emerald-900/40"
                    />
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="space-y-1.5">
                    ...
                    <input
                        ...
                        id="berat"
                        name="berat"
                        value="<?php echo e(old('berat', $barang->berat)); ?>"
                        required
                        step="0.001"
                        min="0"
                        class="w-full rounded-lg border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-900 shadow-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-100 dark:border-neutral-600 dark:bg-neutral-950 dark:text-white dark:focus:border-emerald-400 dark:focus:ring-emerald-900/40"
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="flex rounded-lg border border-neutral-300 bg-white text-sm shadow-sm focus-within:border-emerald-500 focus-within:ring-2 focus-within:ring-emerald-100 dark:border-neutral-600 dark:bg-neutral-950 dark:focus-within:border-emerald-400 dark:focus-within:ring-emerald-900/40">
                        ...
                        <input
                            ...
                            id="harga"
                            name="harga"
                            value="<?php echo e($selectedPrice); ?>"
                            step="0.01"
                            min="0"
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/barang/edit.blade.php ENDPATH**/ ?>