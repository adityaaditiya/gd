...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('Tambah Barang Gadai')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Tambah Barang Gadai'))]); ?>
    <div class="space-y-8">
        <div class="flex flex-col gap-2">
            <h1 class="text-2xl font-semibold text-neutral-900 dark:text-white"><?php echo e(__('Tambah Barang Gadai')); ?></h1>
            <p class="text-sm text-neutral-600 dark:text-neutral-300">
                <?php echo e(__('Lengkapi formulir berikut untuk menambahkan data barang jaminan baru beserta informasi penaksiran.')); ?>
        ...
        <div class="rounded-xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-700 dark:bg-neutral-800">
            <form
                method="POST"
                action="<?php echo e(route('gadai.barang-jaminan.store')); ?>"
                class="space-y-6 p-6"
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/gadai/barang-jaminan/create.blade.php ENDPATH**/ ?>