                        ...
                        <tr class="align-top hover:bg-neutral-50 dark:hover:bg-neutral-700/70">
                            ...
                            <td class="whitespace-nowrap px-4 py-3">
                                <?php if($isPeriodic): ?>
                                    -
                                <?php else: ?>
                                    <?php echo e(number_format((float) $transaksi->tarif_bunga_harian * 100, 2, ',', '.')); ?>%
                                <?php endif; ?>
                            </td>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('940de34a-1bcf-41d6-b8e8-ceede4d9c07c')): $__env->markAsRenderedOnce('940de34a-1bcf-41d6-b8e8-ceede4d9c07c'); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/gadai/lihat-gadai.blade.php ENDPATH**/ ?>