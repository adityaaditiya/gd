...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('Laporan Transaksi Gadai')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Laporan Transaksi Gadai'))]); ?>
    <div class="space-y-6">
        <div class="flex flex-col gap-2">
            <h1 class="text-2xl font-semibold text-neutral-900 dark:text-white"><?php echo e(__('Laporan Transaksi Gadai')); ?></h1>
            <!-- <p class="text-sm text-neutral-600 dark:text-neutral-300">
                <?php echo e(__('Ringkasan transaksi gadai yang sedang berjalan maupun telah selesai, tanpa termasuk transaksi batal.')); ?>

            </p> -->
            <p class="text-sm text-neutral-600 dark:text-neutral-300">
                <?php echo e(__('Ringkasan transaksi gadai.')); ?>

            </p>
        </div>

        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <form method="GET" action="<?php echo e(route('laporan.transaksi-gadai')); ?>" class="w-full max-w-md">
                <label for="search-transaksi-gadai" class="sr-only"><?php echo e(__('Cari transaksi')); ?></label>
                <div class="flex items-center gap-2">
                    <div class="relative flex-1">
                        <input
                            ...
                            class="w-full rounded-lg border border-neutral-200 bg-white py-2 px-3 text-sm text-neutral-700 shadow-sm transition focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-200 dark:border-neutral-700 dark:bg-neutral-900 dark:text-white dark:focus:border-emerald-400 dark:focus:ring-emerald-500/40"
                        />
                    </div>
                    <?php if(!empty($search)): ?>
                        <a
            ...
            <table class="min-w-full divide-y divide-neutral-200 text-left text-sm text-neutral-700 dark:divide-neutral-700 dark:text-neutral-200" data-report-transaksi-table>
                <thead class="bg-neutral-50 text-xs uppercase tracking-wide text-neutral-500 dark:bg-neutral-900 dark:text-neutral-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3"><?php echo e(__('Pencairan Gadai')); ?></th>
                        <th scope="col" class="px-4 py-3"><?php echo e(__('Bunga Maksimum')); ?></th>
                        <th scope="col" class="px-4 py-3"><?php echo e(__('Bunga Terhutang Riil')); ?></th>
                        ...
                        <tr class="align-top hover:bg-neutral-50 dark:hover:bg-neutral-700/70">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-col">
                                    ...
                                    <?php if(!empty($transaksi->nasabah?->telepon)): ?>
                                        <span class="text-xs text-neutral-500 dark:text-neutral-300"><?php echo e($transaksi->nasabah->telepon); ?></span>
                                    <?php endif; ?>
                                    <span class="text-xs text-neutral-500 dark:text-neutral-300">
                                        <?php echo e($transaksi->nasabah?->kode_member ? __('no member: :kode', ['kode' => $transaksi->nasabah->kode_member]) : '—'); ?>
                            ...
                            <td class="px-4 py-3">
                                ...
                                <?php else: ?>
                                    ...
                                    <div id="<?php echo e($collateralTemplateId); ?>" class="hidden" data-report-collateral-template>
                                        <div class="space-y-4">
                                                    ...
                                                    <div class="flex flex-col gap-2">
                                                        ...
                                                        <dl class="grid grid-cols-1 gap-3 text-sm text-neutral-700 dark:text-neutral-200">
                                                            <div class="space-y-1">
                                                                ...
                                                                <dd><?php echo e($barang->kondisi ?? '—'); ?></dd>
                                                            </div>
                                                            <div class="space-y-1">
                            ...
                            <td class="px-4 py-3">
                                <div class="font-semibold text-emerald-600 dark:text-emerald-300">Rp <?php echo e(number_format((float) $transaksi->uang_cair, 0, ',', '.')); ?></div>
                            </td>
                            <td class="px-4 py-3">
                                <div class="font-semibold text-emerald-600 dark:text-emerald-300">
                                    <?php if((float) $transaksi->total_bunga > 0): ?>
                                        Rp <?php echo e(number_format((float) $transaksi->total_bunga, 0, ',', '.')); ?>

                                    <?php else: ?>
                                        —
                                    <?php endif; ?>
                                </div>
                                <?php if((float) $transaksi->tarif_bunga_harian > 0): ?>
                                    <div class="text-xs text-neutral-500 dark:text-neutral-300">
                                        <?php echo e(__('Tarif bunga harian: :rate%', ['rate' => rtrim(rtrim(number_format((float) $transaksi->tarif_bunga_harian, 2, '.', ''), '0'), '.')])); ?>
                            ...
                            <td class="px-4 py-3">
                                <div class="font-semibold text-emerald-600 dark:text-emerald-300">
                                    <?php if((float) $transaksi->bunga_terutang_riil > 0): ?>
                                        Rp <?php echo e(number_format((float) $transaksi->bunga_terutang_riil, 0, ',', '.')); ?>
                            ...
                            <!-- <td class="whitespace-nowrap px-4 py-3">
                                <span class="inline-flex rounded-full bg-emerald-100 px-3 py-1 text-xs font-semibold text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-300">
                                    <?php echo e($transaksi->status_transaksi ?? __('Belum ada status')); ?>
                            ...
                            <td class="whitespace-nowrap px-4 py-3 text-xs text-neutral-600 dark:text-neutral-300">
                                ...
                                <div><?php echo e(__('Jatuh tempo: :date', ['date' => optional($transaksi->jatuh_tempo_awal)->format('d M Y') ?? '—'])); ?></div>
                            </td>
                            <td class="px-4 py-3 text-xs text-neutral-600 dark:text-neutral-300">
                                <div><?php echo e(__('Kasir: :name', ['name' => $transaksi->kasir?->name ?? '—'])); ?></div>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="9" class="px-4 py-6 text-center text-sm text-neutral-500 dark:text-neutral-300">
                                <?php echo e(__('Belum ada transaksi gadai yang tercatat.')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table-pagination','data' => ['paginator' => $transaksiGadai,'perPageOptions' => $perPageOptions,'filters' => request()->except('page')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($transaksiGadai),'per-page-options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($perPageOptions),'filters' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->except('page'))]); ?>
...
<?php endif; ?>
    ...
    <?php if (! $__env->hasRenderedOnce('166561b1-0e41-4b68-b50e-f90f7bec9340')): $__env->markAsRenderedOnce('166561b1-0e41-4b68-b50e-f90f7bec9340'); ?>
...
<?php endif; ?>
<?php /**PATH /var/www/gd/resources/views/laporan/transaksi-gadai.blade.php ENDPATH**/ ?>