...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-header','data' => ['title' => __('Confirm password'),'description' => __('Harap konfirmasi kata sandi Anda sebelum melanjutkan.')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Confirm password')),'description' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Harap konfirmasi kata sandi Anda sebelum melanjutkan.'))]); ?>
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/livewire/auth/confirm-password.blade.php ENDPATH**/ ?>