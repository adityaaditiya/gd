    ...
    <div class="flex flex-col gap-8">
        ...
        <form method="GET" class="grid gap-4 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            <div class="flex flex-col gap-3 md:flex-row md:items-end">
                <div class="flex-1">
                    <label for="search" class="text-sm font-medium text-neutral-700 dark:text-neutral-200"><?php echo e(__('Cari Riwayat Cicilan Nasabah')); ?></label>
                    <div class="mt-2">
                        <input
                            id="search"
                            name="q"
                            ...
                            placeholder="<?php echo e(__('Cari riwayat cicilan dengan kode member..')); ?>"
                    ...
                    <?php $__currentLoopData = $insights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <section class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                            <div class="rounded-lg border border-neutral-200 p-4 dark:border-neutral-700">
                                <dt class="text-xs uppercase tracking-wide text-neutral-500 dark:text-neutral-400"><?php echo e(__('Harga Beli Emas')); ?></dt>
                            ...
                            <div class="rounded-lg border border-neutral-200 p-4 dark:border-neutral-700">
                                <dt class="text-xs uppercase tracking-wide text-neutral-500 dark:text-neutral-400"><?php echo e(__('Saldo Angsuran Tersisa')); ?></dt>
        ...
        <?php if($hasQuery ?? false): ?>
            <header class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <h2 class="text-lg font-semibold text-neutral-900 dark:text-white"><?php echo e(__('Snapshot Cicilan Emas')); ?></h2>
                </div>
            ...
            <dl class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-900">
                    <dt class="text-xs uppercase tracking-wide text-neutral-500 dark:text-neutral-400"><?php echo e(__('Total Saldo Angsuran Tersisa')); ?></dt>
                ...
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-900">
                    <dt class="text-xs uppercase tracking-wide text-neutral-500 dark:text-neutral-400"><?php echo e(__('Total Angsuran Tercatat')); ?></dt>
