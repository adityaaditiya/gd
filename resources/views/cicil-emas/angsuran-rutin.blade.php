    ...
    <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2">
            ...
            <p class="text-neutral-600 dark:text-neutral-300">
                {{ __('Kelola proses angsuran, validasi pembayaran, dan hitung denda keterlambatan secara real-time.') }}
            </p>
        </div>
            ...
            <form method="GET" class="grid gap-3 rounded-lg border border-neutral-200 bg-neutral-50 p-4 text-sm dark:border-neutral-700 dark:bg-neutral-900 md:grid-cols-5">
                <div class="md:col-span-2">
                    <label class="flex flex-col gap-1">
                        <span class="text-xs font-semibold uppercase tracking-wide text-neutral-500 dark:text-neutral-400">{{ __('Cari Nomor Cicilan / Kode Member / NIK') }}</span>
                        <input
                            type="search"
                            name="search"
                            value="{{ $filters['search'] ?? '' }}"
                            placeholder="{{ __('Masukan nomor cicilan, kode member atau NIK') }}"
