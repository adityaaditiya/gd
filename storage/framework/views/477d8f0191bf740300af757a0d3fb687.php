            ...
            <table class="min-w-full divide-y divide-neutral-200 dark:divide-neutral-700">
                <thead class="bg-neutral-50 text-xs uppercase tracking-wide text-neutral-500 dark:bg-neutral-900 dark:text-neutral-400">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-neutral-600 dark:text-neutral-300"><?php echo e(__('Nomor Lelang')); ?></th>
                        ...
                        <th scope="col" class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-neutral-600 dark:text-neutral-300"><?php echo e(__('Saldo Kas Masuk')); ?></th>
                ...
                <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                    <?php $__empty_1 = true; $__currentLoopData = $jadwalLelang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="text-sm text-neutral-800 dark:text-neutral-100">
                            ...
                            <td class="px-4 py-3"><?php echo e($jadwal->nomor_lelang ?? '—'); ?></td>
                            <td class="px-4 py-3">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="9" class="px-4 py-6 text-center text-sm text-neutral-500 dark:text-neutral-400"><?php echo e(__('Belum ada data lelang yang sesuai filter.')); ?></td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php endif; ?>
        ...
        <div class="grid gap-3 rounded-lg border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-700 dark:bg-neutral-900 md:grid-cols-4">
            <div class="flex flex-col gap-1">
                <span class="text-sm text-neutral-500 dark:text-neutral-400"><?php echo e(__('Total Hasil Lelang')); ?></span>
            ...
            <div class="flex flex-col gap-1">
                <span class="text-sm text-neutral-500 dark:text-neutral-400"><?php echo e(__('Saldo Kas Masuk')); ?></span>
...
<?php endif; ?>
<?php /**PATH /var/www/gd/resources/views/laporan/lelang.blade.php ENDPATH**/ ?>