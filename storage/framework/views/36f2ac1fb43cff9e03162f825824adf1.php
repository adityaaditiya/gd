...
<?php if (! $__env->hasRenderedOnce('882ff4ef-a880-4e3e-945c-7bd0410942e2')): $__env->markAsRenderedOnce('882ff4ef-a880-4e3e-945c-7bd0410942e2'); ?>
    <script>
        (() => {
                        ...
                        <div role="dialog" aria-modal="true" class="w-full max-w-md rounded-xl border border-neutral-200 bg-white p-6 text-neutral-800 shadow-xl dark:border-neutral-700 dark:bg-neutral-800 dark:text-neutral-100">
                            <div class="flex flex-col gap-4">
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-neutral-900 dark:text-neutral-300">${<?php echo \Illuminate\Support\Js::from(__('Apakah data sudah sesuai??'))->toHtml() ?>}</p>
                                </div>
