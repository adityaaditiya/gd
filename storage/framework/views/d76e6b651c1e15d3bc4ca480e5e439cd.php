        ...
        <section class="grid gap-4 rounded-xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
            ...
            <dl class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800/60">
                    ...
                    <dd class="text-xl font-semibold text-neutral-900 dark:text-white">Rp <?php echo e(number_format($metrics['total_financed'] ?? 0, 0, ',', '.')); ?></dd>
                </div>
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800/60">
                    <dt class="text-xs uppercase tracking-wide text-neutral-500 dark:text-neutral-400"><?php echo e(__('Total Pokok Tercatat')); ?></dt>
                    <dd class="text-xl font-semibold text-neutral-900 dark:text-white">Rp <?php echo e(number_format($metrics['total_principal'] ?? 0, 0, ',', '.')); ?></dd>
                </div>
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800/60">
                ...
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800/60">
                    ...
                    <dd class="text-xl font-semibold text-neutral-900 dark:text-white">Rp <?php echo e(number_format($metrics['total_administration'] ?? 0, 0, ',', '.')); ?></dd>
                </div>
                <div class="rounded-lg border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-700 dark:bg-neutral-800/60">
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/laporan/cicil-emas.blade.php ENDPATH**/ ?>