        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="space-y-2">
                ...
                <p class="text-sm text-neutral-600 dark:text-neutral-300">
                    <?php echo e(__('Konfirmasi penerimaan pelunasan untuk kontrak :number milik :customer.', [
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <label class="flex flex-col gap-2 text-sm text-neutral-700 dark:text-neutral-200">
                        ...
                        <textarea
                            ...
                            placeholder="<?php echo e(__('Catat detail tambahan seperti nomor referensi transfer atau kondisi barang saat ditebus…')); ?>"
...
<?php endif; ?>
<?php /**PATH E:\New folder\laravel 12 php 8\gd\resources\views/gadai/pelunasan.blade.php ENDPATH**/ ?>